...
class Person
  ...
  product = Product.new("Table", 500, "Solid oak") # FIX THIS LINE (wow, this is tricky, still attempting)
  puts "The product's name is #{product.name}."
  



  # on line 43 only 1 argument was given so it only expected 1 but on line 50 3 were given